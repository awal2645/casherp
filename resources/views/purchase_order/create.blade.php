...
<section class="content">
	...
	<div class="row">
			<div class="col-sm-12 text-center">
				<p class="help-block">The purchase order will be saved and sent through Manager, Finance and Administrator approval.</p>
				<button type="button" id="submit_purchase_form" class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-lg tw-text-white"><i class="fas fa-paper-plane" aria-hidden="true"></i> Submit for approval</button>
			</div>
		</div>
