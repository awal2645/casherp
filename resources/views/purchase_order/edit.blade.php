  ...
  <input type="hidden" id="purchase_id" value="{{ $purchase->id }}">
    ...
    <div class="row">
        <div class="col-sm-12 text-center">
          <p class="help-block">Save the requested corrections, then resubmit the rejected order from its approval workspace.</p>
          <button type="button" id="submit_purchase_form" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-lg"><i class="fas fa-save" aria-hidden="true"></i> Save corrections</button>
        </div>
    </div>
{!! Form::close() !!}
</section>
