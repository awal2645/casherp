...
<section class="content">
    ...
    @component('components.widget', ['class' => 'box-primary'])
          ...
          <div class="row check_group">
            ...
            <div class="col-md-9">
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'purchase.document.share', false,
            ...
            <div class="col-md-9">
              @foreach([
                ...
                <div class="col-md-12">
                  <div class="checkbox">
                    <label>
                      {!! Form::checkbox('permissions[]', $procurement_permission, false, ['class' => 'input-icheck']); !!}
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12"><div class="checkbox"><label>{!! Form::checkbox('permissions[]', 'premium_modules.purchase', false, ['class' => 'input-icheck']); !!} Request premium modules and additional capacity</label></div></div>
            <div class="col-md-12"><div class="checkbox"><label>{!! Form::checkbox('permissions[]', 'business.account_closure.manage', false, ['class' => 'input-icheck']); !!} Schedule or cancel company closure <small class="text-danger">(sensitive)</small></label></div></div>
          </div>
        </div>
        <hr>
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            @foreach([
              ...
              <div class="col-md-12"><div class="checkbox"><label>{!! Form::checkbox('permissions[]', $import_permission, false, ['class' => 'input-icheck']); !!} {{ $import_label }}</label></div></div>
            @endforeach
          </div>
        </div>
        <hr>
          ...
          <div class="row check_group">
            ...
            <div class="col-md-9">
              @foreach([
                ...
                <div class="col-md-12">
                  <div class="checkbox"><label>{!! Form::checkbox('permissions[]', $property_permission, false, ['class' => 'input-icheck']); !!} {{ $property_label }}</label></div>
                </div>
              @endforeach
            </div>
          </div>
          ...
          <div class="row check_group">
            ...
            <div class="col-md-9">
              @foreach([
                ...
                <div class="col-md-12"><div class="checkbox"><label>{!! Form::checkbox('permissions[]', $document_permission, false, ['class' => 'input-icheck']); !!} {{ $document_label }}</label></div></div>
              @endforeach
              @if(!empty($document_permission_types) && $document_permission_types->isNotEmpty())
                ...
                @foreach($document_permission_types->groupBy('category') as $document_category => $permission_types)
                  ...
                  @foreach($permission_types as $permission_type)
                    ...
                    <div class="col-md-6"><div class="checkbox"><label>{!! Form::checkbox('permissions[]', $type_permission, false, ['class' => 'input-icheck']); !!} {{ $permission_type->pivot->display_name ?: $permission_type->name }} @if(!$permission_type->pivot->enabled_by_default)<small class="text-muted">(disabled for new)</small>@endif</label></div></div>
                  @endforeach
                @endforeach
              @endif
            </div>
        ...
        <div class="row check_group">
            ...
            @if(in_array('pos_sale', $enabled_modules))
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>{!! Form::checkbox('permissions[]', 'sell.document.share', false, ['class' => 'input-icheck']); !!} Share invoices, quotations and sales documents using public links</label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="checkbox">
