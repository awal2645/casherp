                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::select('hms_property_id', $properties, $room_type->hms_property_id, ['class' => 'form-control select2', 'required', 'placeholder' => __('messages.please_select')]) !!}
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        ...
                        @foreach($room_type->media as $media)
                            <div class="img-thumbnail">
                                <span class="badge bg-red delete-media" data-method="DELETE" data-href="{{ route('hms.room_media.destroy', $media->id) }}"><i class="fas fa-times"></i></span>
                                {!! $media->thumbnail() !!}
                            </div>
                        @endforeach
                        <div class="form-group">
