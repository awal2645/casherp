            ...
            <div class="col-md-8">
                @component('components.widget', ['title' => __('hms::lang.add_bookings')])
                    <div class="row">
                        ...
                        @include('hms::bookings.partials.operational_fields')
                        <div class="col-md-6">
                            <div class="form-group">
                       ...
                       <div class="col-md-6">
                            ...
                            {!! Form::label('id_proof', ($settings?->id_proof_label_1 ?? __('hms::lang.id_proof_1')) . ':') !!}
                                ...
                                {!! Form::file('id_proof_1[]', [
                                    ...
                                    'required' => ($settings && isset($settings->is_id_proof_1_required) && $settings->is_id_proof_1_required) ? 'required' : null,
                                ]) !!}
                            </div>
                       </div>
                       <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::file('id_proof_2[]', [
                                    ...
                                    'multiple' => true,
                                    'class' => 'upload-element',
                                    'required' => ($settings && isset($settings->is_id_proof_2_required) && $settings->is_id_proof_2_required) ? 'required' : null,
                                ]) !!}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::file('id_proof_3[]', [
                                    ...
                                    'multiple' => true,
                                    'class' => 'upload-element',
                                    'required' => ($settings && isset($settings->is_id_proof_3_required) && $settings->is_id_proof_3_required) ? 'required' : null,
                                ]) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('hms_reason_for_trip', null, [
                                    'class' => 'form-control',
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('hms_vehicle_registration_number', null, [
                                    'class' => 'form-control',
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('hms_place_of_origin', null, [
                                    'class' => 'form-control',
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('hms_final_destination', null, [
                                    'class' => 'form-control',
                        ...
                        <div class="row">
                            <div class="col-md-8 booking_add_room">
                                ...
                                <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white add-room">
                                    @lang('messages.add') @lang('hms::lang.rooms')
                                </button>
                            </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" name="extras[{{ $extra->id }}][id]" class="extra"
                                                        ...
                                                        data-classification="{{ $extra->financial_classification ?: 'revenue' }}">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-5 text-right">
                                <strong class="security_deposit_price">0.00</strong>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 text-right">
                                <strong class="total_tax_show">0.00</strong>
                            </div>
                        </div>
                        <div class="row">
                            <hr>
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <div class="radio-inline">
                                        <label>
                                            <input type="radio" name="discount_type_radio" value="percentage" checked>
                                            @lang('hms::lang.percentage')
                                        </label>
                                    </div>
                                    <div class="radio-inline">
                                        <label>
                                            <input type="radio" name="discount_type_radio" value="fixed">
            ...
            <div class="col-md-12">
                ...
                @component('components.widget')
                    @include('partials.advance_deposit_guidance', [
                        'advanceGuideId' => 'hms-create-booking-advance-guide',
                        'advanceGuideTotalSelector' => '#final_total_input',
