...
@section('content')
       ...
       <div class="col-md-8">
        <div class="box box-solid">
            ...
            <div class="box-body">
                ...
                @include('hms::bookings.partials.operational_fields', ['transaction' => $transaction])
                <div class="col-md-6">
                    <div class="form-group">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                @foreach($transaction->media as $media)
                                    @if($media->model_media_type == 'id_proof_1')
                                            ...
                                            <div class="img-thumbnail position-relative" style="width: 100px; height: auto;">
                                            <span class="badge bg-red position-absolute  delete-media" style="z-index: 100;"
                                                data-method="DELETE" data-href="{{ action([Modules\Hms\Http\Controllers\HmsBookingController::class, 'deleteMedia'], ['media_id' => $media->id]) }}">
                                                <i class="fas fa-times"></i>
                                            </span>
                                                <a href="{{ $media->display_url }}" target="_blank">
                                                    <i class="fas fa-file-pdf fa-3x text-danger d-block mx-auto my-3"></i>
                                                </a>
                                            </div>
                                            @else
                                            <div class="img-thumbnail position-relative" style="width: 100px; height: auto; top: -10px;">
                                            <span class="badge bg-red position-absolute  delete-media" style="z-index: 100;"
                                                data-method="DELETE" data-href="{{ action([Modules\Hms\Http\Controllers\HmsBookingController::class, 'deleteMedia'], ['media_id' => $media->id]) }}">
                                                <i class="fas fa-times"></i>
                                            </span>
                                            <img src="{{ $media->display_url }}" style="width: 100%; height: 50px;" class="img-thumbnail">
                                            </div>
                                            @endif
                                    @endif
                                @endforeach
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            @foreach($transaction->media as $media)
                                @if($media->model_media_type == 'id_proof_3')
                                        ...
                                        <img src="{{ $media->display_url }}" style="width: 100%; height: 50px;" class="">
                                        </div>
                                        @endif
                                @endif
                            @endforeach
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('hms_reason_for_trip', __('hms::lang.reason_for_trip') . ':') !!}
                        {!! Form::textarea('hms_reason_for_trip', $transaction->hms_reason_for_trip, [
                            'class' => 'form-control',
                            'placeholder' => __('hms::lang.reason_for_trip'),
                            'rows' => 3,
                        ]) !!}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('hms_means_of_transport', __('hms::lang.means_of_transport') . ':') !!}
                        {!! Form::select('hms_means_of_transport', [
                            'car' => __('hms::lang.car'),
                            'motorcycle' => __('hms::lang.motorcycle'),
                            'plane' => __('hms::lang.plane'),
                            'train' => __('hms::lang.train'),
                            'bus' => __('hms::lang.bus'),
                            'taxi' => __('hms::lang.taxi'),
                            'other' => __('hms::lang.other'),
                        ], $transaction->hms_means_of_transport, [
                            'class' => 'form-control',
                            'placeholder' => __('hms::lang.means_of_transport'),
                        ]) !!}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('hms_vehicle_registration_number', __('hms::lang.vehicle_registration_number') . ':') !!}
                        {!! Form::text('hms_vehicle_registration_number', $transaction->hms_vehicle_registration_number, [
                            'class' => 'form-control',
                            'placeholder' => __('hms::lang.vehicle_registration_number'),
                        ]) !!}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('hms_place_of_origin', __('hms::lang.place_of_origin') . ':') !!}
                        {!! Form::text('hms_place_of_origin', $transaction->hms_place_of_origin, [
                            'class' => 'form-control',
                            'placeholder' => __('hms::lang.place_of_origin'),
                        ]) !!}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('hms_final_destination', __('hms::lang.final_destination') . ':') !!}
                        {!! Form::text('hms_final_destination', $transaction->hms_final_destination, [
                            'class' => 'form-control',
                            'placeholder' => __('hms::lang.final_destination'),
                        ]) !!}
                    </div>
                </div>
                ...
                <div class="col-md-8 booking_add_room">
                    ...
                    <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white add-room">  @lang('messages.add') @lang('hms::lang.rooms')</button>
                </div>
                <div class="col-md-4">
                    <table class="table table-bordered">
                        <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                     <input type="checkbox" name="extras[{{ $extra->id }}][id]" class="extra" value="{{$extra->id}}" data-value="{{$extra->price_per}}" data-price="{{$extra->price}}" data-classification="{{ $extra->financial_classification ?: 'revenue' }}" @if (in_array($extra->id, $extras_id))
                                         checked
                                     @endif>
                                     ...
                                     @if($extra->financial_classification === 'refundable_security_deposit')
                                         <br><span class="label label-info">Refundable · held outside invoice income</span>
                                     @endif
                                </td>
                            </tr>
                            @endforeach
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-xs-7">
                            ...
                            <small class="text-muted">Held separately; not revenue, tax or invoice balance.</small>
                        </div>
                        <div class="col-xs-5 text-right">
                            <strong class="display_currency security_deposit_price" data-currency_symbol="true">0.00</strong>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-6">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <strong>@lang('hms::lang.booking_tax') :</strong>
                        </div>
                        <div class="col-xs-6 text-right">
                            <strong class="display_currency total_tax_show" data-currency_symbol="true">0.00</strong>
                        </div>
                    </div>
                    <div class="row">
                    <hr>
                    ...
                    // Determine discount type and value from existing transaction
                    if($discount_percent_disable == 0 && $transaction->discount_amount > 0) {
                        if($transaction->discount_type == 'percentage') {
                            $discount_type = 'percentage';
                            $discount_value = number_format($transaction->discount_amount, 2);
                        } else {
                            $discount_type = 'fixed';
                            $discount_value = number_format($transaction->discount_amount, 2);
                        }
                    ...
                    <div class="col-xs-12">
                        <div class="form-group">
                            <div class="radio-inline">
                                <label>
                                    <input type="radio" name="discount_type_radio" value="percentage" {{ $discount_type == 'percentage' ? 'checked' : '' }}>
                                    @lang('hms::lang.percentage')
                                </label>
                            </div>
                            <div class="radio-inline">
                                <label>
                                    <input type="radio" name="discount_type_radio" value="fixed" {{ $discount_type == 'fixed' ? 'checked' : '' }}>
                                    @lang('hms::lang.fixed_amount')
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            {!! Form::number('discount_amount', $discount_value, [
                                'class' => 'form-control',
                                'id' => 'discount_amount',
                                'disabled' => $discount_percent_disable == 1 ? 'disabled' : null,
                                'placeholder' => $discount_type == 'percentage' ? __('hms::lang.discount_percent') : __('hms::lang.discount_amount'),
                            ]) !!}
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="form-group">
                                {!! Form::label('tax_rate_id', __('hms::lang.booking_tax') . ':') !!}
                                {!! Form::select('tax_rate_id', $taxes['tax_rates'], $transaction->tax_id ?? '', [
                                    'class' => 'form-control select2',
                                    'id' => 'tax_rate_id',
                                    'placeholder' => __('messages.please_select'),
                                    'data-default' => $transaction->tax_id ?? ''
                                ], $taxes['attributes']) !!}
                                <input type="hidden" name="tax_calculation_amount" id="tax_calculation_amount" value="{{ $transaction->tax_amount ?? 0 }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="box-body">
                    <div class="row">
                            @include('partials.advance_deposit_guidance', [
                                'advanceGuideId' => 'hms-edit-booking-advance-guide',
                                'advanceGuideTotalSelector' => '#total_booking_amount',
                                'advanceGuidePaidSelector' => '.payment-amount',
                                'advanceGuideContext' => 'room, stay, or hospitality reservation',
                            ])
    ...
    <button type="submit" name="submit_action" value="save" id="submit_action" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-lg">@lang('messages.save')</button>
    </div>
       {!! Form::close() !!}
           {{-- model  --}}
        ...
        $(document).ready(function() {
            ...
            $(".view_modal_room").on("show.bs.modal", function() {
                ...
                $("#edit_booking_room").submit(function(event) {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            'arrival_date': $('#arrival_date').val(),
                            'departure_date': $('#departure_date').val(),
                            'hms_rate_plan_id': $('#hms_rate_plan_id').val(),
                ...
                $('#type').on('change', function(){
                    ...
                    $.ajax({
                        ...
                        'room_ids': roomIds,
                        'hms_group_booking_id': $('#hms_group_booking_id').val(),
                        },
                        success: function(result) {
            ...
            function setStatus(){
                if($('#status').val() == 'cancelled'){
                    ...
                    $('.status_value').html(statusTranslations.cancelled);
                } else if($('#status').val() == 'confirmed'){
                    $('.status_value').html(statusTranslations.confirmed);
                    $('.status-heading').css('background-color', 'green');
                } else if($('#status').val() == 'pending'){
                    $('.status-heading').css('background-color', 'yellow');
                    $('.status_value').html(statusTranslations.pending)
                } else{
                    $('.status-heading').css('background-color', '#f5f5f5');
                    $('.status_value').html(statusTranslations.status)
                }
            }
            ...
            async function calculateAllPrice() {
                    ...
                    await Promise.all(
                        $('.booking_add_room table tbody tr').map(async function() {
                            ...
                            tr.find('.price-td').text(__currency_trans_from_en(total_price, true));
                    ...
                    $('.extra').each(async function() {
                        if ($(this).prop('checked')) {
                            ...
                            var line_amount = price;
                            if (per_type == 'per_person') line_amount = person * price;
                            if (per_type == 'per_day') line_amount = calculateDays() * price;
                            if (per_type == 'per_day_per_person') line_amount = calculateDays() * person * price;
                            $('#' + $(this).val()).val(line_amount);
                            if ($(this).data('classification') === 'refundable_security_deposit') {
                                security_deposit_amount += parseFloat(line_amount);
                            } else {
                                extra_amount += parseFloat(line_amount);
                            }
                        } else {
                            $('#' + $(this).val()).val('');
                        }
                    ...
                    var discountType = $('input[name="discount_type_radio"]:checked').val();
                    var discountValue = $('#discount_amount').val();
                    
                    if (discountValue != '' && discountValue > 0) {
                        if (discountType === 'percentage') {
                            discount = (discountValue * (extra + room_price) / 100);
                            $('#discount_type').val('percentage');
                            $('#total_discount').val(discountValue);
                    ...
                    // Calculate tax
                    var tax_amount = 0;
                    var subtotal = extra + room_price - total_discount;
                    
                    if ($('#tax_rate_id').val() != '') {
                        var tax_rate = parseFloat($('#tax_rate_id option:selected').data('rate') || 0);
                        tax_amount = (subtotal * tax_rate) / 100;
                    }
                    
                    total = subtotal + tax_amount;
                    $('#total_booking_amount').val(total);
                    $('#total_before_tax').val(extra + room_price);
                    
                    // Update tax display
                    $('.total_tax_show').text(__currency_trans_from_en(tax_amount, true));
                    ...
                    $('.extra_price').text(__currency_trans_from_en(extra_amount, true));
                    $('.security_deposit_price').text(__currency_trans_from_en(security_deposit_amount, true));
                    $('.room_price').text(__currency_trans_from_en(room_price, true));
            }
            ...
            function submitQuickContactForm(form) {
              ...
              $('input[name="discount_type_radio"]').change(function() {
                  var selectedType = $(this).val();
                  var discountInput = $('#discount_amount');
                  
                  if (selectedType === 'percentage') {
                      discountInput.attr('placeholder', "{{ __('hms::lang.discount_percent') }}");
                  } else if (selectedType === 'fixed') {
                      discountInput.attr('placeholder', "{{ __('hms::lang.discount_amount') }}");
                  }
