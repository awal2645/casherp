...
class DataController extends Controller
{
    ...
    public function user_permissions()
    {
        $permissions = [
            ...
            [
                'value' => 'crm.workspace.view',
                'label' => 'View CRM workspace and pipeline',
                'default' => false,
            ],
            [
                'value' => 'crm.pipeline.manage',
                'label' => 'Configure CRM pipelines and stages',
                'default' => false,
            ],
            [
                'value' => 'crm.opportunity.manage',
                'label' => 'Create and manage opportunities',
                'default' => false,
            ],
            [
                'value' => 'crm.activity.manage',
                'label' => 'Create and complete CRM activities',
                'default' => false,
            ],
            [
                'value' => 'crm.reports.view',
                'label' => 'View all CRM performance metrics',
                'default' => false,
            ],
        ];
