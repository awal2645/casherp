...
Route::middleware('web', 'authh', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin', 'business.feature:crm')->prefix('crm')->group(function () {
    ...
    Route::get('dashboard', [Modules\Crm\Http\Controllers\CrmWorkspaceController::class, 'index'])->name('crm.workspace');
    Route::post('workspace/pipelines', [Modules\Crm\Http\Controllers\CrmWorkspaceController::class, 'storePipeline'])->name('crm.workspace.pipelines.store');
    Route::post('workspace/pipelines/{pipeline}/stages', [Modules\Crm\Http\Controllers\CrmWorkspaceController::class, 'storeStage'])->name('crm.workspace.stages.store');
    Route::post('workspace/opportunities', [Modules\Crm\Http\Controllers\CrmWorkspaceController::class, 'storeOpportunity'])->name('crm.workspace.opportunities.store');
    Route::put('workspace/opportunities/{uuid}', [Modules\Crm\Http\Controllers\CrmWorkspaceController::class, 'updateOpportunity'])->name('crm.workspace.opportunities.update');
    Route::patch('workspace/opportunities/{uuid}/stage', [Modules\Crm\Http\Controllers\CrmWorkspaceController::class, 'moveOpportunity'])->name('crm.workspace.opportunities.stage');
    Route::delete('workspace/opportunities/{uuid}', [Modules\Crm\Http\Controllers\CrmWorkspaceController::class, 'archiveOpportunity'])->name('crm.workspace.opportunities.archive');
    Route::post('workspace/opportunities/{uuid}/activities', [Modules\Crm\Http\Controllers\CrmWorkspaceController::class, 'storeActivity'])->name('crm.workspace.activities.store');
    Route::patch('workspace/activities/{uuid}/complete', [Modules\Crm\Http\Controllers\CrmWorkspaceController::class, 'completeActivity'])->name('crm.workspace.activities.complete');
