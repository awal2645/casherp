...
class DataController extends Controller
{
    ...
    public function modifyAdminMenu()
    {
        ...
        if ($is_asset_enabled && app(\App\Services\FeatureAccessService::class)->enabled('assets', $business_id) && (auth()->user()->can('superadmin') || auth()->user()->can('asset.view') || auth()->user()->can('asset.view_own_maintenance') || auth()->user()->can('asset.view_all_maintenance'))) {
