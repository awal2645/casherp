...
class SendSubscriptionExpiryAlert extends Notification
{
    ...
    public function __construct($subscription)
    {
        ...
        $this->days_left = max(0, \Carbon::today()->diffInDays($this->subscription->end_date, false));
    }
    ...
    public function toDatabase($notifiable)
    {
        return [
            ...
            'msg' => strip_tags(__('superadmin::lang.subscription_expiry_alert', ['days_left' => $this->days_left, 'app_name' => config('app.name')])),
            ...
            'severity' => 'warning',
            'due_at' => optional($this->subscription->end_date)->toIso8601String(),
        ];
    }
