        ...
        <div class="col-xs-12">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu tw-rounded-lg">
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item text-center tw-font-bold tw-text-sm md:tw-text-base">Google sign-in</a>
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 pos-tab">
                ...
                @include('superadmin::superadmin_settings.partials.google_social_login')
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        if ($('#welcome_email_body').length) {
            tinymce.init({ selector: 'textarea#welcome_email_body' });
        }
        if ($('#superadmin_register_tc').length) {
            tinymce.init({ selector: 'textarea#superadmin_register_tc' });
        }
    });
</script>
@endsection
