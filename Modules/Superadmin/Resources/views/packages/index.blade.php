                                    ...
                                    <div class="box box-success hvr-grow-shadow">
                                        <div class="box-header with-border text-center">
                                            ...
                                            <div class="row">
                                                ...
                                                <form method="POST" action="{{ action([\Modules\Superadmin\Http\Controllers\PackagesController::class, 'destroy'], [$package->id]) }}" class="package-delete-form tw-inline-block">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-box-tool" title="delete"><i class="fa fa-trash"></i></button>
                                                </form>
                                        ...
                                        <div class="box-body text-center">
                                            ...
                                            @endif
                                            businesses / companies per account
                                            <br />
...
@section('javascript')
<script>
    $(document).on('submit', '.package-delete-form', function (event) {
