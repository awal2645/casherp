                        ...
                        <div class="tw-inline-block tw-min-w-full tw-py-2 tw-align-middle sm:tw-px-5">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::number('max_businesses', 1, ['class' => 'form-control', 'required', 'min' => 0]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>{!! Form::checkbox('data_import_enabled', 1, true) !!} Enable secure data imports</label>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    {!! Form::label('monthly_import_rows', 'Rows per month:') !!}
                                    {!! Form::number('monthly_import_rows', 50000, ['class' => 'form-control', 'required', 'min' => 0]) !!}
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    {!! Form::label('max_import_rows_per_file', 'Rows per file:') !!}
                                    {!! Form::number('max_import_rows_per_file', 10000, ['class' => 'form-control', 'required', 'min' => 1]) !!}
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    {!! Form::label('max_import_file_size_mb', 'Maximum file size (MB):') !!}
                                    {!! Form::number('max_import_file_size_mb', 10, ['class' => 'form-control', 'required', 'min' => 1]) !!}
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    {!! Form::label('concurrent_imports', 'Concurrent imports:') !!}
                                    {!! Form::number('concurrent_imports', 2, ['class' => 'form-control', 'required', 'min' => 1]) !!}
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    {!! Form::label('import_rollback_days', 'Rollback window (days):') !!}
                                    {!! Form::number('import_rollback_days', 7, ['class' => 'form-control', 'required', 'min' => 0, 'max' => 90]) !!}
                                </div>
                            </div>
                            <div class="clearfix"></div>
