                        ...
                        <div class="tw-inline-block tw-min-w-full tw-py-2 tw-align-middle sm:tw-px-5">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    {!! Form::label('max_businesses', 'Businesses / companies limit:') !!}
                                    {!! Form::number('max_businesses', $packages->max_businesses, ['class' => 'form-control', 'required', 'min' => 0]) !!}
                                    <span class="help-block">Enter 0 for unlimited companies under one account.</span>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <h4>Data import allowance</h4>
                                <p class="text-muted">Control migration capacity per subscribed company. Enter 0 for an unlimited monthly row allowance or to disable rollback.</p>
                            </div>
                            <div class="col-sm-4"><div class="form-group"><label>{!! Form::checkbox('data_import_enabled', 1, $packages->data_import_enabled) !!} Enable secure data imports</label></div></div>
                            <div class="col-sm-4"><div class="form-group">{!! Form::label('monthly_import_rows', 'Rows per month:') !!}{!! Form::number('monthly_import_rows', $packages->monthly_import_rows, ['class' => 'form-control', 'required', 'min' => 0]) !!}</div></div>
                            <div class="col-sm-4"><div class="form-group">{!! Form::label('max_import_rows_per_file', 'Rows per file:') !!}{!! Form::number('max_import_rows_per_file', $packages->max_import_rows_per_file, ['class' => 'form-control', 'required', 'min' => 1]) !!}</div></div>
                            <div class="col-sm-4"><div class="form-group">{!! Form::label('max_import_file_size_mb', 'Maximum file size (MB):') !!}{!! Form::number('max_import_file_size_mb', $packages->max_import_file_size_mb, ['class' => 'form-control', 'required', 'min' => 1]) !!}</div></div>
                            <div class="col-sm-4"><div class="form-group">{!! Form::label('concurrent_imports', 'Concurrent imports:') !!}{!! Form::number('concurrent_imports', $packages->concurrent_imports, ['class' => 'form-control', 'required', 'min' => 1]) !!}</div></div>
                            <div class="col-sm-4"><div class="form-group">{!! Form::label('import_rollback_days', 'Rollback window (days):') !!}{!! Form::number('import_rollback_days', $packages->import_rollback_days, ['class' => 'form-control', 'required', 'min' => 0, 'max' => 90]) !!}</div></div>
                            <div class="clearfix"></div>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('businesses[]', $businesses, (array) $packages->businesses, [
                                        'class' => 'form-control select2',
                                        'multiple',
                                    ]) !!}
                                </div>
