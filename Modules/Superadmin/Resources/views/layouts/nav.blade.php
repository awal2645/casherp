        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li @if(request()->segment(1) == 'superadmin' && request()->segment(2) == 'industry-features') class="active" @endif><a href="{{ route('superadmin.industry-features.index') }}">Industry features</a></li>

                    <li @if(request()->segment(1) == 'superadmin' && request()->segment(2) == 'industry-documents') class="active" @endif><a href="{{ route('superadmin.industry-documents.index') }}">Industry documents</a></li>

                    <li @if(request()->segment(1) == 'superadmin' && request()->segment(2) == 'premium-modules') class="active" @endif><a href="{{ route('superadmin.premium-modules.index') }}">Premium modules</a></li>
