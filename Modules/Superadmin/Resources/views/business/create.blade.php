		...
		<div class="tw-flow-root tw-mt-5 tw-border-b tw-border-gray-200">
			<div class="tw-mx-4 tw--my-2 tw-overflow-x-auto sm:tw--mx-5">
				<div class="tw-inline-block tw-min-w-full tw-py-2 tw-align-middle sm:tw-px-5">
					{!! Form::open(['url' => action([\Modules\Superadmin\Http\Controllers\BusinessController::class, 'store']), 'method' => 'post', 'id' => 'business_register_form','files' => true, 'data-onboarding-form' => true, 'data-draft-key' => 'casherp:admin-company:' . auth()->id() ]) !!}
                    @include('business.partials.register_form')
                    <div class="clearfix"></div>
                    <div class="col-md-12"><hr></div>
                    <div class="col-md-4">
            ...
            $("form#business_register_form").validate({
                ...
                rules: {
                    ...
                    email: {
                        email: true,
                        remote: {
                            url: window.CASHERP_CHECK_EMAIL_URL,
                            type: "post",
                            data: {
                                email: function() {
                                    return $( "#email" ).val();
                    ...
                    username: {
                        ...
                        minlength: 4,
                        remote: {
                            url: window.CASHERP_CHECK_USERNAME_URL,
                            type: "post",
                            data: {
                                username: function() {
                                    return $( "#username" ).val();
