...
class NotificationUtil extends Util
{
    ...
    public function configureEmail($notificationInfo = [], $check_superadmin = true)
    {
        ...
        // Laravel 9 reads mail.mailers.smtp.*, not the Laravel 5-era mail.*
        // keys previously set here. The central resolver also decrypts stored
        // secrets and purges Laravel's cached mailer between SaaS tenants.
        app(BusinessMailConfigurationService::class)
            ->applyFromSettings($email_settings, $check_superadmin);
    }
