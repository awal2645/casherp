...
class BusinessUtil extends Util
{
    ...
    public function newBusinessDefaultResources($business_id, $user_id)
    {
        ...
        // Industry document defaults are provisioned only after the feature
        // migration exists, keeping fresh installs and rolling deployments safe.
        app(\App\Services\IndustryDocumentCatalogService::class)->provisionForBusiness($business);
    ...
    public function defaultEmailSettings()
    {
        return [
            ...
            'from_address' => '',
            'from_name' => '',
            'timeout' => (int) config('casherp_mail.default_timeout', 15),
        ];
    }
