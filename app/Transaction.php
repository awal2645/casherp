...
class Transaction extends Model
{
    ...
    public function procurementDocument()
    {
        return $this->hasOne(\App\ProcurementDocument::class);
    }

    public function sourceProcurementDocument()
    {
        return $this->belongsTo(\App\ProcurementDocument::class, 'procurement_document_id');
    }

    public function procurementDepartment()
    {
        return $this->belongsTo(\App\Category::class, 'procurement_department_id');
    }

    public function procurementCurrency()
    {
        return $this->belongsTo(\App\Currency::class, 'procurement_currency_id');
    }
