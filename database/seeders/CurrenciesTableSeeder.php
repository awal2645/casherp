...
class CurrenciesTableSeeder extends Seeder
{
     ...
     *
     * Safe to re-run: creates the table if the base schema is missing,
     * then upserts every currency by id so existing installs are not duplicated.
     *
     * @return void
     */
    public function run()
    {
        ...
        $data = [
            ...
            ['id' => '2', 'country' => 'America', 'currency' => 'Dollars', 'code' => 'USD', 'symbol' => '$',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null, ],
            ['id' => '3', 'country' => 'Afghanistan', 'currency' => 'Afghanis', 'code' => 'AFN', 'symbol' => '؋',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null, ],
            ...
            ['id' => '6', 'country' => 'Australia', 'currency' => 'Dollars', 'code' => 'AUD', 'symbol' => '$',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null, ],
            ['id' => '7', 'country' => 'Azerbaijan', 'currency' => 'New Manats', 'code' => 'AZN', 'symbol' => 'ман',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null, ],
            ...
            ['id' => '16', 'country' => 'Botswana', 'currency' => "Pula's", 'code' => 'BWP', 'symbol' => 'P',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null, ],
            ['id' => '17', 'country' => 'Bulgaria', 'currency' => 'Leva', 'code' => 'BGN', 'symbol' => 'лв',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null, ],
            ...
            ['id' => '79', 'country' => 'Mongolia', 'currency' => 'Tugriks', 'code' => 'MNT', 'symbol' => '₮',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null, ],
            ['id' => '80', 'country' => 'Mozambique', 'currency' => 'Meticais', 'code' => 'MZN', 'symbol' => 'MT',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null, ],
            ...
            ['id' => '93', 'country' => 'Paraguay', 'currency' => 'Guarani', 'code' => 'PYG', 'symbol' => 'Gs',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null, ],
            ['id' => '94', 'country' => 'Peru', 'currency' => 'Nuevos Soles', 'code' => 'PEN', 'symbol' => 'S/.',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null, ],
            ['id' => '95', 'country' => 'Philippines', 'currency' => 'Pesos', 'code' => 'PHP', 'symbol' => 'Php',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null, ],
            ['id' => '96', 'country' => 'Poland', 'currency' => 'Zlotych', 'code' => 'PLN', 'symbol' => 'zł',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null, ],
            ['id' => '97', 'country' => 'Qatar', 'currency' => 'Rials', 'code' => 'QAR', 'symbol' => '﷼',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null, ],
            ['id' => '98', 'country' => 'Romania', 'currency' => 'New Lei', 'code' => 'RON', 'symbol' => 'lei',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null, ],
            ...
            ['id' => '133', 'country' => 'Kenya', 'currency' => 'Kenyan shilling', 'code' => 'KES', 'symbol' => 'KSh',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null, ],
            ['id' => '134', 'country' => 'Bangladesh', 'currency' => 'Taka', 'code' => 'BDT', 'symbol' => '৳',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null],
            ['id' => '135', 'country' => 'Algeria', 'currency' => 'Algerian dinar', 'code' => 'DZD', 'symbol' => 'د.ج',
                'thousand_separator' => ' ', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null],
            ['id' => '136', 'country' => 'United Arab Emirates', 'currency' => 'United Arab Emirates dirham', 'code' => 'AED', 'symbol' => 'د.إ',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null],
            ['id' => '137', 'country' => 'Uganda', 'currency' => 'Uganda shillings', 'code' => 'UGX', 'symbol' => 'USh',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null],
            ['id' => '138', 'country' => 'Tanzania', 'currency' => 'Tanzanian shilling', 'code' => 'TZS', 'symbol' => 'TSh',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null],
            ['id' => '139', 'country' => 'Angola', 'currency' => 'Kwanza', 'code' => 'AOA', 'symbol' => 'Kz',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null],
            ['id' => '140', 'country' => 'Kuwait', 'currency' => 'Kuwaiti dinar', 'code' => 'KWD', 'symbol' => 'KD',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null],
            ['id' => '141', 'country' => 'Bahrain', 'currency' => 'Bahraini dinar', 'code' => 'BHD', 'symbol' => 'BD',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null],
            ['id' => '142', 'country' => 'Tunisia', 'currency' => 'Tunisian Dinar', 'code' => 'TND', 'symbol' => 'د.ت',
                'thousand_separator' => ',', 'decimal_separator' => '.', 'created_at' => null, 'updated_at' => null],
        ];
        ...
        foreach ($data as $row) {
            ...
            DB::table('currencies')->updateOrInsert(['id' => $id], $row);
        }
    ...
    {
        $nextId = ((int) DB::table('currencies')->max('id')) + 1;
        $driver = Schema::getConnection()->getDriverName();

        if ($driver === 'mysql') {
            DB::statement('ALTER TABLE currencies AUTO_INCREMENT = '.$nextId);
        }
    }
}
