...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! Schema::hasTable('procurement_approval_steps')) {
        ...
        if (Schema::hasTable('procurement_documents') && Schema::hasTable('procurement_supplier_quotes')) {
        ...
        if (! Schema::hasTable('procurement_events')) {
        ...
        if (Schema::hasTable('transactions') && ! Schema::hasColumn('transactions', 'procurement_document_id')) {
            Schema::table('transactions', function (Blueprint $table) {
                $table->unsignedBigInteger('procurement_document_id')->nullable()->index();
                $table->unsignedInteger('procurement_department_id')->nullable()->index();
                $table->unsignedInteger('procurement_currency_id')->nullable()->index();
